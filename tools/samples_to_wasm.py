...
libc_filename = os.path.join(this_dir, "..", "librt", "libc", "lib.c")
libio_filename = os.path.join(this_dir, "..", "librt", "io.c3")
...
samples = list(
    glob.iglob(
        os.path.join(this_dir, "..", "test", "samples", "simple", "*.c")
    )
) + list(
    glob.iglob(
        os.path.join(this_dir, "..", "test", "samples", "simple", "*.c3")
    )
)
