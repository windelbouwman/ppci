...
from .registers import RiscvFRegister, RiscvRegister, F1, F2, R0
from .tokens import RiscvToken, RiscvIToken, RiscvSToken
from .instructions import call_internal2, call_internal1, Li, B, Bne
import struct
...
def make_fcmp(mnemonic, func3, invert):
    ...
    if not invert:
        ...
        patterns = {
            'opcode': 0b1010011, 'rd': rd, 'funct3': func3,
            'rs1': rm, 'rs2': rn, 'funct7': 0b1010000}        
    members = {
        'syntax': syntax, 'rd': rd, 'rn': rn, 'rm': rm,
        'patterns': patterns, 'tokens': tokens, 
        'func3': func3}
