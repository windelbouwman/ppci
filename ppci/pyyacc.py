...
class XaccGenerator:
    ...
    def generate(self, grammar, headers, output_file):
        ...
        self.action_table, self.goto_table = LrParserBuilder(grammar).generate_tables()
    ...
    def generate_python_script(self):
        ...
        self.print('        self.grammar = Grammar()')
        self.print('        self.grammar.add_terminals({})'.format(self.grammar.terminals))
