...
instruction_table = [
    ...
    ("table.init", (0xFC, 12), (ArgType.ELEMIDX, ArgType.TABLEIDX)),
    ("table.drop", (0xFC, 13), (ArgType.ELEMIDX,)),
    ("table.copy", (0xFC, 14), (ArgType.TABLEIDX, ArgType.TABLEIDX)),
    ("table.grow", (0xFC, 15), (ArgType.TABLEIDX,)),
    ("table.size", (0xFC, 16), (ArgType.TABLEIDX,)),
    ("table.fill", (0xFC, 17), (ArgType.TABLEIDX,)),
