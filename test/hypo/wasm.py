...
i32_value = i32_const | i32_binop() | i32_load()
i32_expr = i32_value | st.just(('call', '$func3'))

# @given(integers(min_value=-10000000000000, max_value=100000000000000))
@given(i64_expr, i32_expr, i64_value, st.binary(min_size=100, max_size=200))
@settings(deadline=600)
def test_equivalent_behavior(expr64, expr32, v64, mem):
    # assume(s != 0)
    # print('code', v64, v32)
